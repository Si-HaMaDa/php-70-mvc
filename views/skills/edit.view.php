...
<div class="content">
    ...
    <form class="card row g-3 my-3" method="post" action="<?= make_url('/admin/skills/update?id=' . $skill['id']) ?>" enctype="multipart/form-data">
        <div class="card-body row">

            <div class="col-sm-12">
                <label for="Name" class="form-label">Name</label>
                <input type="text" class="form-control" id="Name" name="name" placeholder="" value="<?= get_old_value('name') ?? $skill['name'] ?>" required>
